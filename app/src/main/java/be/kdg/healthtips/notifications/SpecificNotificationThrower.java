...
public class SpecificNotificationThrower {
    ...
    public static void throwYouSportBeforeSleeping(Context context) {
        NotificationThrower.throwSpecificTip(context, NotificationThrower.IconType.T_SLEEP, "Sporten voor slapen", "", TipDetailActivity.class, "Sporten voor slapen", "Wees ook voorzichtig met sporten vlak voor het slapen gaan. Sommige niet-slapers proberen zich af te sloven vlak voordat ze naar bed gaan, in de hoop dat de slaap op die manier wel gaat komen. Dat is echter een misrekening, want te zware lichaamsinspanningen zullen een negatief in plaats van een positief effect hebben.\n" +
                "\n" +
    ...
    public static void throwBadFoodHabit(Context context) {
        ...
        NotificationThrower.throwSpecificTip(context, NotificationThrower.IconType.T_FOOD, "Eetgewoonte", "Probeer deze af te leren", TipDetailActivity.class, "Slechte eetgewoontes", "U heeft de gewoonte om elke zondag -fastfood- te eten, probeer dit af te leren.");
    }
}
